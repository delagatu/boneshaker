...
class ControllerPagePartial
{
    ...
    const PAGE_MANAGEMENT_COMPONENT_SUB_TYPE = 'addComponentSubType';
    ...
    const PAGE_MANAGEMENT_VIEW_COMPONENT_SUB_TYPE = 'subCategoriiComponente';
    ...
    const PAGE_MANAGEMENT_VALIDATE_COMPONENT_SUB_TYPE = 'validateComponentSubType';
    ...
    const PARTIAL_ADD_COMPONENT_SUB_TYPE = '_addComponentSubType';
    ...
    const PARTIAL_MANAGEMENT_VIEW_COMPONENT_SUB_TYPE = '_subCategoriiComponente';
