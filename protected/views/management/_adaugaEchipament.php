...
$this->pageTitle = 'Boneshaker | Adauga Echipamente';
...
<div class="grid_9 form" id = "addBicicleForm">
    ...
    <h2 class="center_content">Echipamente</h2>
    ...
    <div class="row">
        <?php echo $form->labelEx($addProductForm, 'equipment_type_id'); ?>
        <?php echo Chosen::activeDropDownList($addProductForm, 'equipment_type_id', $addProductForm->equipmentList(),
        array('class' => 'addBicicleDropDown long-input',
            'id' => 'addEquipmentType',
            'empty' => 'Selecteaza',
            'data-add-url' => $this->createUrl(ControllerPagePartial::PAGE_MANAGEMENT_EQUIPMENT_TYPE),
            'data-dialog-id' => 'addEquipmentTypeDialog',
            'data-title' =>'Echipamente'
        ));
        ?>
