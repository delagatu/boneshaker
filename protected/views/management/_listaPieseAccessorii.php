...
<div class='grid_13 prepend-top-20'>
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
            ...
            array(
                'header' => 'Operatiuni',
                'type' => 'raw',
                'value' => '$data->getAccessoryEditLink()',
                'filter' => false,
            ),
    ...
    echo Chtml::link('Adauga accesorii', $this->createUrl(ControllerPagePartial::ACTION_ADD), array('class' => 'action-link'));
