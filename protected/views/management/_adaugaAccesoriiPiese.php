...
$this->pageTitle = 'Boneshaker | Adauga Piese si Accesorii';
...
<div class="grid_9 form" id = "addBicicleForm">
    ...
    <div class="row">
        <?php echo $form->labelEx($addProductForm, 'accessory_type_id'); ?>
        <?php echo Chosen::activeDropDownList($addProductForm, 'accessory_type_id', $addProductForm->accessoryList(),
        array('class' => 'addBicicleDropDown long-input',
            'id' => 'addAccessoryType',
            'empty' => 'Selecteaza',
            'data-add-url' => $this->createUrl(ControllerPagePartial::PAGE_MANAGEMENT_ACCESSORY_TYPE),
