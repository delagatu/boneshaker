...
<div class='grid_13 prepend-top-20'>
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
            ...
            array(
                ...
                'value' => '$data->getName()',
                'filter' => CHtml::textField('bicycle_name_sort', $name, array('class' => 'styled-input medium-input', 'placeholder' => 'Cauta')),
            ),
            ...
            array(
                'header' => 'Operatiuni',
                'type' => 'raw',
                'value' => '$data->getBikeAvailableActions()',
                'filter' => false,
            ),
    ...
    echo Chtml::link('Adauga bicicleta', $this->createUrl(ControllerPagePartial::PAGE_ADD_BICYCLE), array('class' => 'action-link'));
