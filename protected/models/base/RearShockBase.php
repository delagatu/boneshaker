...
/**
 * This is the model class for table "rear_shock".
 *
 * The followings are the available columns in table 'rear_shock':
 * @property integer $id
 ...
 */
class RearShockBase extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'bicycleDescriptions' => array(self::HAS_MANY, 'BicycleDescription', 'rear_shock_id'),
	 ...
	 * @return RearShockBase the static model class
	 */
