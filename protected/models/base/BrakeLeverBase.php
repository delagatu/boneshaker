...
/**
 * This is the model class for table "brake_lever".
 *
 * The followings are the available columns in table 'brake_lever':
 * @property integer $id
 ...
 */
class BrakeLeverBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BrakeLeverBase the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'bicycleDescriptions' => array(self::HAS_MANY, 'BicycleDescription', 'brake_lever_id'),
