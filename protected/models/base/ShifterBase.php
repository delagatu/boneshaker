...
/**
 * This is the model class for table "shifter".
 *
 * The followings are the available columns in table 'shifter':
 * @property integer $id
 ...
 */
class ShifterBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ShifterBase the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'bicycleDescriptions' => array(self::HAS_MANY, 'BicycleDescription', 'shifter_id'),
