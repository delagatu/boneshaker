...
/**
 * This is the model class for table "chain_wheel".
 *
 * The followings are the available columns in table 'chain_wheel':
 * @property integer $id
 ...
 */
class ChainWheelBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ChainWheelBase the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'bicycleDescriptions' => array(self::HAS_MANY, 'BicycleDescription', 'chain_wheel_id'),
