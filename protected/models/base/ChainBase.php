 ...
 *
 * The followings are the available columns in table 'chain':
 * @property integer $id
 ...
 */
class ChainBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ChainBase the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'bicycleDescriptions' => array(self::HAS_MANY, 'BicycleDescription', 'chain_id'),
