...
/**
 * This is the model class for table "bb_set".
 *
 * The followings are the available columns in table 'bb_set':
 * @property integer $id
 ...
 */
class BbSetBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BbSetBase the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			...
			'bicycleDescriptions' => array(self::HAS_MANY, 'BicycleDescription', 'bb_set_id'),
		);
	}
