...
/**
 * This is the model class for table "rim".
 *
 * The followings are the available columns in table 'rim':
 * @property integer $id
 ...
 */
class RimBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RimBase the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'bicycleDescriptions' => array(self::HAS_MANY, 'BicycleDescription', 'front_rim_id'),
			'bicycleDescriptions1' => array(self::HAS_MANY, 'BicycleDescription', 'rear_rim_id'),
