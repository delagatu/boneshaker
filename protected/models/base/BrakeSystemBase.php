...
/**
 * This is the model class for table "brake_system".
 *
 * The followings are the available columns in table 'brake_system':
 * @property integer $id
 ...
 */
class BrakeSystemBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BrakeSystemBase the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'bicycleDescriptions' => array(self::HAS_MANY, 'BicycleDescription', 'brake_system_id'),
